      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          <div className="text-center mb-8">
            <img src="/etii-logo-nobg.png" alt="ETII" className="h-16 w-auto mx-auto mb-3 object-contain" />
    ...
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-md border-b border-border h-14 flex items-center px-4 sm:px-6">
        <div className="flex items-center gap-2 flex-1">
          <img src="/etii-logo-nobg.png" alt="ETII" className="h-8 w-auto object-contain" />
          <span className="font-display text-xl font-bold tracking-tight">ETII Admin</span>
        </div>
