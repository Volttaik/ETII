      ...
      <div className="flex items-center justify-center min-h-screen pt-16 px-4 py-12">
        ...
        >
          <div className="text-center mb-8">
            <img src="/etii-logo-nobg.png" alt="ETII" className="h-16 w-auto mx-auto mb-4 object-contain" />
            <h1 className="font-display text-3xl font-bold">Create account</h1>
            <p className="text-sm text-muted-foreground mt-1">Join ETII and discover premium fashion</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 flex flex-col gap-4 shadow-sm">
            ...
            <button
              ...
              className="mt-2 w-full bg-foreground text-background py-3 rounded-full font-semibold text-sm hover:bg-foreground/80 transition-colors disabled:opacity-60"
            >
